        ...
        <main style={{
            ...
            <div className="glass" style={{ width: '100%', maxWidth: '460px', padding: '3rem 2.5rem' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '2.25rem' }}>
                    ...
                    <h1 style={{ fontSize: '1.75rem', fontWeight: 700, color: '#1a1a2e' }}>Create account</h1>
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <p style={{ fontSize: '0.75rem', color: '#6b7280' }}>₹1,00,000 starting balance on account creation</p>
                    </div>
                </div>
